...
geoXML3.parser = function (options) {
  ...
  var hideDocument = function (doc,map) 
  {
    if(!doc) doc = docs[0];
    // Hide the map objects associated with a document 
    var i;
    if(doc != null && doc.markers != null)
    {
    	for (i = 0; i < doc.markers.length; i++) 
		{
            if(null != doc.markers[i].infoWindow)
            {
  ...
  var showDocument = function (doc,map) 
  {
	if(!doc) doc = docs[0];
...
//      icon:     placemark.style.icon,
      icon: "http://svcttimi03.dot.ca.gov/images/traffic32x32.png",
    ...
    if (doc!=null) 
    {
      if(doc.markers == null) doc.markers = new Array();
