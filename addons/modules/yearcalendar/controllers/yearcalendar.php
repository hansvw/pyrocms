...
class Yearcalendar extends Public_Controller
{
	...
	function __construct()
	{
		...
		$this->lang->load('yearcalendar');
        $this->yearselections = array(
        	'2011' => '2011',
        	'2012' => '2012',
        	'2013' => '2013');
        $this->selectionjs = 'id="yearselector" onChange="this.form.submit();"';
        $this->template->append_metadata( css('yearcalendar.css', 'yearcalendar') );
	}
