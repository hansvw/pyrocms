...
class Monthcalendar extends Public_Controller
{
    public function __construct()
    {
    	parent::Public_Controller();
    	$this->load->model('availability_m');
    	$this->template->append_metadata( css('monthcalendar.css', 'monthcalendar') );
 	}
	...
	/// we call _date function 	
        ...
        $this->template
                ->append_metadata( js('monthcalendar.js', 'monthcalendar') )
